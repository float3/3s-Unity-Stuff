...
namespace tinycpp
{
	...
	public class Tokenizer
	{
		...
		private readonly tokenizer_getc_buf getc_buf = new tokenizer_getc_buf();
		// };
		...
		private bool get_string(char quote_char, out token tout, bool wide)
		{
			int s = 1;
			bool escaped = false;
		...
		private bool ignore_until(string marker, int col_advance, bool stop_at_newline = false)
		{
			column += col_advance;
			int c;
			do
		...
		private class tokenizer_getc_buf
		{
			public string buf = "";
			public int cnt;
		}
